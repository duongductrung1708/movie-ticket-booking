...
var useFieldV6TextField = (params) => {
  ...
  const selectionSyncTimeoutRef = React23.useRef();
  const {
    forwardedProps: {
      onFocus,
      onClick,
...
var DateField = React29.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
// node_modules/@mui/x-date-pickers/DesktopDatePicker/DesktopDatePicker.js
var DesktopDatePicker = React45.forwardRef(function DesktopDatePicker2(inProps, ref) {
  var _a, _b;
  const translations = usePickersTranslations();
  const utils = useUtils();
