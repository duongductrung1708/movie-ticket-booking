...
} from "./chunk-4EYOL7TW.js";
import {
  InputAdornment_default,
  getInputAdornmentUtilityClass,
  inputAdornmentClasses_default
} from "./chunk-I35CJQZ5.js";
import {
  Chip_default,
  Popper_default,
  chipClasses_default,
...
} from "./chunk-FZSQQCPZ.js";
import {
  Dialog_default,
  dialogClasses_default,
  getDialogUtilityClass
} from "./chunk-M22TL6R2.js";
import {
  Backdrop_default,
  Fade_default,
  FocusTrap_default,
...
var Grid = React35.forwardRef(function Grid2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(GridContext_default.Provider, {
    value: columns,
    children: (0, import_jsx_runtime33.jsx)(GridRoot, {
      ownerState,
      className: clsx_default(classes.root, className),
      as: component,
      ref,
...
var Tab = React89.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime80.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime80.jsxs)(React89.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime80.jsxs)(React89.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
var TableSortLabel = React92.forwardRef(function TableSortLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime83.jsxs)(TableSortLabelRoot, {
    className: clsx_default(classes.root, className),
    component: "span",
    disableRipple: true,
    ownerState,
    ref,
    ...other,
    children: [children, hideSortIcon && !active ? null : (0, import_jsx_runtime83.jsx)(TableSortLabelIcon, {
      as: IconComponent,
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React93.useRef();
...
var TabScrollButton = React94.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
...
var Tabs = React95.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [mounted, setMounted] = React95.useState(false);
  const [indicatorStyle, setIndicatorStyle] = React95.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React95.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React95.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React95.useState(false);
  const [scrollerStyle, setScrollerStyle] = React95.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React95.useRef(null);
  const tabListRef = React95.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React95.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime86.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime86.jsx)(ScrollButtonComponent, {
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime86.jsx)(ScrollButtonComponent, {
      slots: {
  ...
  const indicator = (0, import_jsx_runtime86.jsx)(TabsIndicator, {
    ...TabIndicatorProps,
  ...
  return (0, import_jsx_runtime86.jsxs)(TabsRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component,
    ...
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime86.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime86.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
